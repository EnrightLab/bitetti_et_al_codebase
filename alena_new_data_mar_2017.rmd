...
points(wt_median[grep("mir-29[a-z]",rownames(mircounts))],mt_median[grep("mir-29[a-z]",rownames(mircounts))],cex=0.4,pch=19,col="green")
points(wt_median[sig],mt_median[sig],cex=1,col="red")
text(wt_median[grep("mir-29[a-z]",rownames(mircounts))],mt_median[grep("mir-29[a-z]",rownames(mircounts))],cex=0.4,pos=1,labels=rownames(mircounts)[grep("mir-29[a-z]",rownames(mircounts))])
